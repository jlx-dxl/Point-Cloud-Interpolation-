...
if __name__ == '__main__':
    # net = FlowNet3D()
    #
    # points1 = torch.rand(1,3,16384)
    # points2 = torch.rand(1,3,16384)
    # features1 = torch.rand(1,3,16384)
    # features2 = torch.rand(1,3,16384)
    #
    # flow = net(points1, points2, features1, features2)
    #
    # print(flow.shape)
