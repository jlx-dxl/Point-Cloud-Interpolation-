...
from Models.Models import PolyPCI
...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str,
                        default='./Models/result_models/field_2_interval_5_freeze_1_npoint_16000/10scenes/')
    ...
    parser.add_argument('--pretrained_self_model', type=str,
                        default='./Models/result_models/field_2_interval_5_freeze_1_npoint_16000/1scene/field_2_0.4047063953346676.pth')
...
def train(args):
    ...
    net = PolyPCI(field=args.field, degree=args.degree, freeze=args.freeze).cuda()
    wandb.watch(net)
...
if __name__ == '__main__':
    ...
    wandb.init(project='PolyPCI', config=args, name='field=3,degree=6,1scenes,train:' + now_time)
